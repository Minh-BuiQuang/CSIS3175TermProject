...
public class DatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    private void PopulateData(SQLiteDatabase db) {
        ...
        addBookRecord(new Book(0l, "The Count of Monte Cristo", 2l, 2l, "98656532", "Alexandre Dumas", "1844", "The Count of Monte Cristo is an adventure novel written by French author Alexandre Dumas completed in 1844.", 421, Book.STATUS_ACTIVE), db);
    }
}
